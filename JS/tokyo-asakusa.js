...
document.addEventListener('scroll', (e) => {
    ...
    h2.style.setProperty('--percentage', `${scrolled * 200}%`)
})

const section = document.querySelector('.under-title-section')
document.addEventListener('scroll', (e) => {
    let scrolled = document.documentElement.scrollTop / (document.documentElement.scrollHeight - document.documentElement.clientHeight)
    section.style.setProperty('--percentage', `${scrolled * 200}%`)
})
...
//revealing h3, h4, h4, h6, .div-h3, .div-h4, .div-h5, .div-h6 while scrolling
